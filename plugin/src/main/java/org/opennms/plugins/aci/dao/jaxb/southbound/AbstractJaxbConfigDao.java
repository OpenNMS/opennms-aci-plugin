...
import org.opennms.plugins.aci.spring.FileReloadCallback;
import org.opennms.plugins.aci.spring.FileReloadContainer;
...
public abstract class AbstractJaxbConfigDao<K, V> implements InitializingBean {
     ...
     * <p>getContainer</p>
     *
     * @return a {@link FileReloadContainer} object.
     */
